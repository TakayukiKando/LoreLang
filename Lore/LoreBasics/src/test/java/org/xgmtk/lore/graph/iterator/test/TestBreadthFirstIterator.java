...
import org.xgmtk.lore.graph.iterator.BreadthFirstIterator;
 ...
 */
public class TestBreadthFirstIterator {
    private static final Logger LOGGER  = Logger.getLogger(TestBreadthFirstIterator.class.getName());
    
    private static final int[] EXPECTED_ITERATION = {0, 1, 4, 2, 3, 5, 6};
    ...
    public void testAdjacencyListGraphIteratorAndPath(){
        ...
        assertGraphIteratorAndPath(SampleGenericGraphs.createAdjacencyListGraphBuilder(),
                (g)->new BreadthFirstIterator<>(g, g.getNode(0)),
